...
public class BrycenChildFragment extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mChildDatabaseReference = mFirebaseDatabase.getReference("Child").child("Brycen");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        nameTextView.setText(getString(R.string.brycen_child_name));
        ...
        switch (v.getId() ) {
            case R.id.use_minutes_button:
                if (!TextUtils.isEmpty(editTextMinutes.getText())) {
                    ...
                    mChildDatabaseReference.setValue(String.valueOf(newTime));
                    Toast.makeText(SwitchTime.getContext(), "Brycen has used " + usedTime + " minutes", Toast.LENGTH_SHORT).show();
                }
